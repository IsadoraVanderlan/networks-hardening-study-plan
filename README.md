...
| :----: | :--------------------------------- | :----------------------------------------------------------------------------------------------------------- | :----: | :---------------------------: |
| **01** | Modelo OSI vs. TCP/IP na Prática   | [Hardware Redes Brasil](https://www.youtube.com/watch?v=3gpo0N04OY0&list=PLAp37wMSBouCyqVtvzLm5JS4dorY-q4uZ) |   ✅   | [Ver Resumo](./Resumos/01.md) |
...
| **35** | `dig` — Diagnóstico e Investigação de DNS        | -                                                     |   ✅   | [Ver Resumo](./Resumos/35.md) |
| **36** | `curl` — Análise de HTTP/HTTPS                   | -                                                     |   ✅   | [Ver Resumo](./Resumos/36.md) |
| **37** | `nc` / Netcat — Teste de Conectividade e Portas  | -                                                     |   ✅   | [Ver Resumo](./Resumos/37.md) |
| **38** | `openssl s_client` — Análise de TLS              | -                                                     |   ✅   | [Ver Resumo](./Resumos/38.md) |
